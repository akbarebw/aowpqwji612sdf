...
class DetailPeriodePerkuliahanController extends Controller
{
    public function index()
    {
        $prodi = Prodi::orderBy('created_at', 'desc')->get();
        return view('dashboard.detail-periode-perkuliahan.index', compact('prodi'));
    }

    public function data_table(Request $request)
    {
        $query = DetailPeriodePerkuliahan::orderBy('created_at', 'desc');
    ...
    {
        $detailperiodeperkuliahan = DetailPeriodePerkuliahan::find($id);
        return view('dashboard.detail-periode-perkuliahan.print', compact('detailperiodeperkuliahan'));
    }
}
