<div class="card rounded-2 box-shadow-1 mb-5">
    <div class="card-content">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('username', null, ['class' => 'form-control border-left-pink border-left-6 text-bold-600 black font-medium-2']) !!}
                    </div>
            ...
            <div class="card bg-grey bg-lighten-4 rounded-2 p-1">
                <div class="row">
                    {!! Form::label('s_role_id', 'Hak Akses Diberikan',['class' => 'col-auto label-control text-uppercase mb-0 mt-10', 'rquired']) !!}
                    <div class="skin skin-flat col-auto mt-10">
