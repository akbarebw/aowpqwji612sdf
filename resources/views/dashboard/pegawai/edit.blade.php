    ...
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('dashboard.pegawai.update', $pegawai->id) }}" method="POST" enctype="multipart/form-data" id="addStaffForm">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group text-center">
                                        <img src="{{ asset('storage/img/pegawai/' . $pegawai->foto ) }}" alt="" accept="image/*"
                                        onchange="previewImage(event)" class="img-fluid" style="width: 50%; border-radius: 10px;">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="nama" name="nama" type="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $pegawai->nama) }}">
                                        @error('nama')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="nip" name="nip" type="text" class="form-control @error('nip') is-invalid @enderror" value="{{ old('nip', $pegawai->nip ) }}">
                                        @error('nip')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="kontak" name="kontak" type="text" class="form-control @error('kontak') is-invalid @enderror" value="{{ old('kontak', $pegawai->kontak ) }}">
                                        @error('kontak')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="tempat_lahir" name="tempat_lahir" type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" value="{{ old('tempat_lahir', $pegawai->tempat_lahir ) }}">
                                        @error('tempat_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input id="mdate" name="tanggal_lahir" type="date"  class="form-control datepicker-default form-control @error('tanggal_lahir') is-invalid @enderror" value="{{ old('tanggal_lahir', $pegawai->tanggal_lahir ) }}">
                                ...
                                <div class="col-sm-12 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input id="umur" name="umur" type="number" class="form-control @error('umur') is-invalid @enderror" value="{{ old('umur', $pegawai->umur ) }}">
                                        @error('umur')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $pegawai->email) }}">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="id_agama" name="id_agama" class="form-control @error('id_agama') is-invalid @enderror">
                                    ...
                                    @foreach ($agama as $item)
                                        <option value="{{ $item->id_agama }}" {{ old('id_agama', $pegawai->id_agama) == $item->id_agama ? 'selected' : '' }}>{{ $item->nama_agama }}</option>
                                    @endforeach
                                </select>
                                @error('id_agama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input id="kewaranegaraan" name="kewaranegaraan" type="text" class="form-control @error('kewaranegaraan') is-invalid @enderror" value="{{ old('kewaranegaraan', $pegawai->kewaranegaraan ) }}">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input id="kontak_darurat" name="kontak_darurat" type="text" class="form-control @error('kontak_darurat') is-invalid @enderror" value="{{ old('kontak_darurat', $pegawai->kontak_darurat ) }}">
                                ...
                                <select name="jabatan_struktural_id[]" multiple id="jabatan_struktural" class="form-control select2" data-placeholder="Pilih Jabatan Struktural">
                                    @foreach ($jabatanStruktural as $item)
                                        <option value="{{ $item->id }}"
                                            {{ in_array($item->id, $pegawaiJabatanStruktural) ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="jabatan_fungsional_id[]" multiple id="jabatan_fungsional" class="form-control select2" data-placeholder="Pilih Jabatan Fungsional">
                                    @foreach ($jabatanFungsional as $item)
                                        <option value="{{ $item->id }}"
                                            {{ in_array($item->id, $pegawaiJabatanFungsional) ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_pegawai_id[]" multiple id="status_pegawai_id" class="form-control select2" data-placeholder="Pilih Status Kepegawaian">
                                    @foreach ($statusPegawais as $item)
                                        <option value="{{ $item->id }}"
                                            {{ in_array($item->id, $pegawaiStatus) ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="aset_id[]" multiple id="aset_id" class="form-control select2" data-placeholder="Pilih Aset">
                                    @foreach ($asets as $item)
                                        <option value="{{ $item->id }}"
                                            {{ in_array($item->id, $pegawaiAset) ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="pangkat_golongan_id" id="pangkat_golongan_id" class="form-control select2" data-placeholder="Pilih Pangkat Golongan">
                                    @foreach ($golongans as $item)
                                        <option value="{{ $item->id }}" {{ $item->id == $pegawai->pangkat_golongan_id ? 'selected' : '' }}>
