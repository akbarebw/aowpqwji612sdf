...
<div class="row">
    <div class="col-xl-12 col-xxl-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('dashboard.aset.store')}}" method="post"enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="file" placeholder="Enter First Name" type="file" class="form-control" name="file" value="{{ old('file')}}">
                            </div>
                        </div>
