...
<div class="row">    
        ...
        <div class="widget-stat card bg-warning">
            <div class="card-body">
                <div class="media">
                    ...
                    <div class="media-body text-white">
                        <p class="mb-1">Total Dosen Aktif</p>
        ...
        <div class="widget-stat card bg-secondary">
            <div class="card-body">
                <div class="media">
                    ...
                    <div class="media-body text-white">
                        <p class="mb-1">Total Program Studi</p>
                        <h3 class="text-white">{{ $prodi }}</h3>
                        <div class="progress mb-2 bg-white">
    ...
    {{-- <div class="col-xl-3 col-md-6">
        <div class="card">
            <img class="img-fluid rounded-top" src="{{ asset('asset_dashboard/images/courses/pic1.jpg') }}" alt="">
            <div class="card-body">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <img class="img-fluid rounded-top" src="{{ asset('asset_dashboard/images/courses/pic2.jpg') }}" alt="">
            <div class="card-body">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <img class="img-fluid rounded-top" src="{{ asset('asset_dashboard/images/courses/pic3.jpg') }}" alt="">
            <div class="card-body">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <img class="img-fluid rounded-top" src="{{ asset('asset_dashboard/images/courses/pic4.jpg') }}" alt="">
            <div class="card-body">
...
@push('js')
    <script src="{{ asset('asset_dashboard/vendor/chartist/js/chartist.min.js') }}"></script>
    <script src="{{ asset('asset_dashboard/js/dashboard/dashboard-default.js') }}"></script>
@endpush
@endsection
