                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('dashboard.pengajuan.create') }}" class="btn btn-primary">Ajukan</a>
                            </div>
                            <div class="card-body">
...
<script>
    $(document).ready(function () {
        ...
        $('#pengajuan').on('click', '.delete', function () {
            let id = $(this).data('id');
            let url = '{{ route("dashboard.pengajuan.destroy", ":id") }}';
