...
@section('title','list-rencana-evaluasi')
@section('content')
<div class="row">
    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4>Data List Rencana Evaluasi</h4>
            </div>
        </div>
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                {{-- {{ Breadcrumbs::render('list-rencana-evaluasi') }} --}}
            </ol>
        </div>
    </div>
                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Semua List Rencana Evaluasi</h4>
...
<script>
    $(document).ready(function() {
        ...
        $('#data_table').DataTable({
            ...
            pageLength: 50,
            ajax : {
                url: "{{ route('list-rencana-evaluasi.data_table') }}",
                data: function (d) {
                    d.prodi = $('#prodi').val();
                }
            },
            columns: [
                ...
                { data: 'jenis_evaluasi', name: 'jenis_evaluasi' },
                ...
                { data: 'nama_evaluasi', name: 'nama_evaluasi' },
                { data: 'deskripsi_indonesia', name: 'deskripsi_indonesia' },
                { data: 'deskrips_inggris', name: 'deskrips_inggris' },
                { data: 'bobot_evaluasi', name: 'bobot_evaluasi' },
