...
@section('title','list-aktivitas-mahasiswa')
@section('content')
<div class="row">
    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4>Data List Aktivitas Mahasiswa</h4>
            </div>
        </div>
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                {{-- {{ Breadcrumbs::render('list-aktivitas-mahaiswa') }} --}}
            </ol>
        </div>
    </div>
                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Semua List Aktivitas Mahasiswa</h4>
...
<script>
    $(document).ready(function () {
        ...
        $('#data_table').DataTable({
            ...
            pageLength: 50,
            ajax : {
                url: "{{ route('list-aktivitas-mahasiswa.data_table') }}",
                data: function (d) {
                    d.prodi = $('#prodi').val();
                }
            },
            columns: [
                ...
                { data: 'asal_data', name: 'asal_data' },
                { data: 'nama_program_mbkm', name: 'nama_program_mbkm' },
                { data: 'nama_jenis_anggota', name: 'nama_jenis_anggota' },
