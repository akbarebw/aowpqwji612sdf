...
<div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                {{ Breadcrumbs::render('krs-mahasiswa') }}
            </ol>
        </div>
    </div>
                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Semua Krs Mahasiswa</h4>
                        ...
                        <div class="card-body">
                            ...
                            <table id="krsmahasiswa" class="display text-nowrap" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            <th>No</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#krsmahasiswa').DataTable({
            processing: true,
            serverSide: true,
            ajax : {
                url: "{{ route('krs-mahasiswa.data_table') }}",
                data: function (d) {
                    d.prodi = $('#prodi').val();
        ...
        $('#prodi').on('change', function() {
            $('#krsmahasiswa').DataTable().ajax.reload();
        });
