                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Semua Matakuliah</h4>
                            <a href="{{ route('dashboard.datamaster.mata.kuliah.create') }}" class="btn btn-primary float-end">+ Add new</a>
                        </div>
                        <div class="row m-2">
                            <h4>Filter</h4>
                            <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="matakuliah" class="display text-nowrap" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            <th>No</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#matakuliah').DataTable({
            ...
            pageLength: 50,
            ajax : {
                url: "{{ route('mata-kuliah.data_table') }}",
                data: function (d) {
                    d.prodi = $('#prodi').val();
                }
            },
