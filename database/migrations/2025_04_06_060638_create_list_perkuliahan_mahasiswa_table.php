...
return new class extends Migration
{
    ...
    {
        Schema::create('list_perkuliahan_mahasiswa', function (Blueprint $table) {
            ...
            $table->decimal('biaya_kuliah_smtr', 10, 2)->nullable();
            ...
            $table->foreign('id_pembiayaan')->nullable()->references('id_pembiayaan')->on('pembiayaan');

            $table->index(['id_prodi', 'id_semester', 'id_pembiayaan'], 'list_perkuliahan_mhs_index');
        });
    }
    ...
    {
        Schema::dropIfExists('list_perkuliahan_mahasiswa');
    }
};
